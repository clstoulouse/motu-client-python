...
deprecatedWarnMsg='"motu-client" module is deprecated since version1.8. Now module named "motuclient" without a dash separator between motu and client shall be used instead of "motu-client".'
